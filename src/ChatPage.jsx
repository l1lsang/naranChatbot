...
export default function ChatPage({ user }) {
 ...
 const sendMessage = async (text) => {
  ...
  if (trimmed === "시작") {
    const template = `✅키워드:/n
✅사기내용:/n
✅구성선택:/n/n
1) 사기 개연성을 중심으로 한 글/n
2) 주의해야할 위험요소에 대해 디테일하게 분석한 글/n
3) 실제로 드러난 정황을 바탕으로 경고형 분석한 글/n
4) 피해예방과 도움이 되는 내용을 중점으로 쓴 글/n
5) 법적 지식과 판례에 관해 전문가의 시점으로 쓴 글/n
6) 웹사이트 검색 기반으로 실제 뉴스와 실제 사례들을 토대로 한 글/n
