...
“리딩방 사기”는 카카오톡·텔레그램·오픈채팅방 등을 이용해 주식·코인 종목을 ‘찍어준다’며 투자자를 모집하고, 고액 수수료·이용료만 챙기거나 시세조종에 악용하는 불법·기망 행위 전반을 뜻한다. 겉으로는 “합법 유사투자자문” “전문가 리딩방”을 표방하지만, 실제 목적은 투자수익이 아니라 피해자의 돈을 빼내는 데 있는 경우가 많다.

1. 리딩방 사기의 기본 개념
- 등록되지 않은 유사투자자문업자 또는 무자격 개인·조직이
- “고수익 보장·원금보장·전문가 1:1 컨설팅”을 내세워
- 불특정 다수에게 고액의 이용료를 받고
- 엉터리 매매 지시·작전주 끌어들이기·허위 실적 과장 등을 반복

2. 운영 방식
1) 유입 단계: SNS·유튜브·문자·전화 등으로 “무료 리딩체험방” 유도
2) 무료 체험·성공사례 연출: 가짜 수익 인증·바람잡이 대화로 분위기 조성
3) 유료 VIP 전환 압박: 수백만~수천만 원대 이용료·평생회원권 권유
4) 1:1 상담·집요한 설득: 계좌 잔고를 문제 삼고 추가 입금·대출까지 권유

3. 전형적인 수법
- 허위·과장 광고 및 수익률 조작
- 원금 보장·손실 보전 약속 (자본시장법 위반 소지)
- 미등록 투자자문·일임 영업 및 시세조종 연계
- 구조적으로 환불이 어렵게 계약·약관 설계

4. 최근 규제 변화(요지)
- 유사투자자문업자의 단방향 조언 원칙 강화
- 양방향 채널(오픈채팅, 1:1 상담 등)에서 개별 종목·매수가·매도가를 지시하며 대가를 받으면
  미등록 투자자문업에 해당할 수 있음
- 허위·과장 광고, 손실 보전 약속 금지 및 과태료·직권말소·형사고발 가능

5. 법적 평가
- 형법상 사기죄
- 자본시장법 위반(미등록 금융투자업, 시세조종, 부정거래)
- 유사투자자문업 관련 제재 대상

6. 정리
리딩방 사기는
- 카톡·텔레그램·오픈채팅 등에서 “전문가 리딩”“VIP 종목 추천”“수익률 보장”을 내세우고
- 유료로 종목·매매 타이밍을 지시하며
- 허위·과장 정보·원금·이익 보장·미등록 자문·시세조종 등으로
- 투자자에게 큰 손실을 입히고 운영자가 이익을 챙기는 구조를 말한다.`;
